...
const OutputCard = ({ generatedMessage, onRegenerate, onFeedback, isLoading }) => {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col h-full">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        <button 
          ...
          disabled={isLoading}
          className="flex-1 min-w-[120px] bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {isLoading ? (
            <>
